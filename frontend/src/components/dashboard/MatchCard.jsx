...
const ActionButtons = ({ handleDecline, handleAccept }) => {
    ...
    <div className="flex justify-center gap-3 mt-3">
        <button 
            ...
            className="w-32 focus:outline-none text-white bg-secondary hover:bg-secondary-dark focus:ring-4 focus:ring-secondary-light font-medium rounded-lg text-xs px-4 py-2"
        >
            ✖ Reject
        </button>
        <button 
            ...
            className="w-32 focus:outline-none text-white bg-accent hover:bg-secondary-dark focus:ring-4 focus:ring-secondary-light font-medium rounded-lg text-xs px-4 py-2"
        >
            ✓ Accept
        </button>
    </div>)
