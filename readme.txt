...
BackEnd folders contain all Python code for the backend, utilizing Django and PostgreSQL.

FrontEnd folders contain all JSX for the frontend, utilizing ReactJS and TailwindCSS for front-end styling and functionality.
